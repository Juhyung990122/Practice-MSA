...
import static com.yeol.market.fixture.ProductFixture.양배추;
import static com.yeol.market.fixture.ProductFixture.양파;
...
public abstract class AcceptanceTest {
    ...
    void setUp() {
        ...
        당근_UUID = 상품_등록(당근).getUuid();
        대파_UUID = 상품_등록(대파).getUuid();
        감자_UUID = 상품_등록(감자).getUuid();
        양배추_UUID = 상품_등록(양배추).getUuid();
        양파_UUID = 상품_등록(양파).getUuid();
