...
class ProductAcceptanceTest extends AcceptanceTest {
    ...
    void getTop3MenuUntil7days() {
        다중_주문_결제_요청(PointFixture.멤버1_ID, 당근_UUID, 5);
        다중_주문_결제_요청(PointFixture.멤버1_ID, 대파_UUID, 4);
        다중_주문_결제_요청(PointFixture.멤버1_ID, 감자_UUID, 3);
        다중_주문_결제_요청(PointFixture.멤버1_ID, 양배추_UUID, 2);
